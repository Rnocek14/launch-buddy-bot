...
import CompanyDataIndex from "./pages/CompanyDataIndex";
        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/what-they-know" element={<CompanyDataIndex />} />
              <Route path="/what-they-know/:slug" element={<CompanyDataPage />} />
