import { Heart, ArrowRight, Phone, Home, Users } from "lucide-react";
...
export const ParentScanUpsell = ({ exposureCount }: ParentScanUpsellProps) => {
  const handleClick = () => {
    trackEvent("parent_scan_cta_click", { source: "free_scan_results" });
  };

  return (
    <Card className="border-accent/30 bg-gradient-to-br from-accent/5 via-background to-primary/5 overflow-hidden">
          ...
          <div className="flex-1">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-foreground leading-tight">
              {exposureCount && exposureCount > 0
                ? `You have ${exposureCount} exposures. Your parents likely have more — and higher risk.`
                : "Your parents are likely more exposed than you — and at higher risk."}
            </h3>
          </div>
        </div>
