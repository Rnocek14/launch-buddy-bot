...
export const STRIPE_PRICES = {
  ...
  PRO_ANNUAL: {
    id: "price_1TPSsbPqV14jS5m4p1Z7POVT",
    name: "Pro Annual",
    amount: 79,
    currency: "USD",
    interval: "year",
  ...
  PRO_MONTHLY: {
    id: "price_1TPSsaPqV14jS5m4R73DhbOw",
    name: "Pro Monthly",
    amount: 12.99,
    currency: "USD",
    interval: "month",
  ...
  COMPLETE_ANNUAL: {
    id: "price_1TPSsePqV14jS5m42IQMTKiU",
  ...
  COMPLETE_MONTHLY: {
    id: "price_1TPSsdPqV14jS5m4vx0A5XZJ",
  ...
  FAMILY_ANNUAL: {
    id: "price_1TPSsfPqV14jS5m4vegF6HJi",
    name: "Family Annual",
    amount: 179,
    currency: "USD",
    interval: "year",
  ...
  PARENT_SCAN_ONETIME: {
    id: "price_1TPSshPqV14jS5m4e5KpiA6o",
